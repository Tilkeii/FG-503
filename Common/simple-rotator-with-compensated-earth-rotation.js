...
//   for the marker //---
//
//  Also, a problem was observed when you use the original "rotator" in a scene where there are 
//  objects that rotate by themselves (using renderAnim() or setInterval()). Indeed, these
//  objects rotated faster when you dragged the mouse. The code has therefore been modified to compensate
//  for that effect for the particular animation to which this file is associated with (the web page of
//  of "6GEN715 Infographie" course).
//     => You can locate the modification using the marker  //***  (in the code below).
//
//
/**
